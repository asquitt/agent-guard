...
> Historical standalone-product material, preserved on 2026-08-30. Claims, setup instructions, architecture descriptions, pricing, and competitive comparisons below are not current, independently validated, or approved for customer use. See `../../README.md`, `../../PROJECT_STATUS.json`, and `../ARCHIVE_AND_ASSET_MAP.md` for the active repository status.
