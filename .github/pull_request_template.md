...
## AgentGuard acceptance

- [ ] Organization isolation is proven for direct API, proxied, async/Celery, and WebSocket paths touched by this change.
- [ ] Detector bypass, PII/secret redaction, and authenticated delivery behavior are tested where applicable.
