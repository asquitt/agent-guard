...
class AgentGuardClient:
    ...
    Usage::
        ...
        with AgentGuardClient(api_key="ag-...") as client:
    ...
    def list_incidents(self, **filters: Any) -> IncidentList:
        ...
        """
        resp = self._request_with_retry("GET", "/api/v1/incidents/", params=filters)
        raise_for_status(resp)
    ...
    def get_incident(self, incident_id: str) -> Incident:
        ...
        """
        resp = self._request_with_retry("GET", f"/api/v1/incidents/{incident_id}")
        raise_for_status(resp)
